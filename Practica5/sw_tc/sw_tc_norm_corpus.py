...
def normalize_text(text):
    ...
    filtered_tokens = [token.text for token in doc if token.text.lower() not in stopWords and token.text.strip()]
...
data_norm.to_csv('Practica5/sw_tc_classifier_corpus.csv', index=False, encoding='utf-8')